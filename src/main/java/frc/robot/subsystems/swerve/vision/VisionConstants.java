...
public class VisionConstants {
  ...
  public static final String[] PHOTON_CAMERA_NAMES = new String[] {
    "FrontRightCam",
    "FrontLeftCam",
    "BackCam"
  };

  public static final Transform3d[] PHOTON_ROBOT_TO_CAMERA_TRANSFORM = new Transform3d[] {
  ...
  public static final AprilTagFieldLayout APRTIL_TAGS_FIELD_LAYOUT = AprilTagFieldLayout.loadField(AprilTagFields.k2025ReefscapeWelded);
}